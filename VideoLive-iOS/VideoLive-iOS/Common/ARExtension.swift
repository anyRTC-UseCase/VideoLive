...
extension NSObject {
    ...
    func randomMusic() -> String {
        let arr = [
            "https://oss.agrtc.cn/oss/fdfs/fa3afab672df2e0ad674b58da7254e7d.mp3",
            "https://oss.agrtc.cn/oss/fdfs/db2ece4fec8998a306000eff2d648aba.mp3",
            "https://oss.agrtc.cn/oss/fdfs/4e9da1a9b5b27201e84ac3ede23c3899.mp3"]
        return arr[Int(arc4random_uniform(3))]
    }
    ...
    func leaveXHToast(reason: ARLeaveReason) {
        switch reason {
        case .broadcastOffline:
            showToast(text: "主播已离开房间", image: "icon_tip_warning")
            break
        case .timeOut:
            showToast(text: "连接已断开", image: "icon_tip_warning")
            break
        case .tokenExpire:
            showToast(text: "体验时间已到", image: "icon_tip_warning")
            break
        default: break
        }
    }
...
extension UIResponder {
    static let audioLiveNotificationLoginSucess = Notification.Name(rawValue: "audioLiveNotificationLoginSucess")
    static let audioLiveNotificationModifySucess = Notification.Name(rawValue: "audioLiveNotificationModifySucess")
