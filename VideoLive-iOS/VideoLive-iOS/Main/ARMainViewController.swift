...
class ARMainViewController: UICollectionViewController {
    ...
    lazy var placeholder: UILabel = {
        ...
        label.frame = CGRect.init(x: (collectionView.width - 188)/2, y: (collectionView.height - 100)/2, width: 188, height: 20)
    ...
    lazy var createButton: UIButton = {
        ...
        button.frame = CGRect.init(x: ARScreenWidth - 65, y: ARScreenHeight - (self.tabBarController?.tabBar.frame.size.height)! - 104, width: 48, height: 48)
    ...
    override func viewDidLoad() {
        ...
        flowLayout?.itemSize = CGSize.init(width: width, height: width * 1.09)
